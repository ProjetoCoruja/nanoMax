...
/**
 * Constante: ROOT - Representa a pasta raiz do framework.
 **/
define('ROOT', $NM_DIR->root, true);

/**
 * Constante: ROOT_URI - Representa a URI raiz do framework.
 **/
define('ROOT_URI', str_replace(realpath($_SERVER['DOCUMENT_ROOT']), null, $NM_DIR->root), true);
