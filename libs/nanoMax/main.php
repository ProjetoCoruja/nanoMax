...
class nanoMax
{
   ...
   function Autoload()
   {
      ...
      if ( func_num_args() <1 )
      {
         $FileName = $NM_DIR->var .DS .'autoload.xml';
         ...
         {
            trigger_error("Não foi possível ler um arquivo de inicialização do framework nanoMax: '{$FileName}'.", E_USER_ERROR);
            return false;
         }
   ...
   function Assembly()
   {
      ...
      if ( func_num_args() <1 )
      {
         $FileName = $NM_DIR->var .DS .'assembly.xml';
